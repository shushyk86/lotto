    ...
    function getQuote($address) {
        ...
        if ($status) {
            ...
            $quote_data['courierautolux'] = array(
                ...
                'cost' => $cost,
                'tax_class_id' => 0,
				//'text'         => 'Стоимость можно расчитать с помощью <a href="http://autolux.ua/Kalkulyator_stoimosti" target="_blank">калькулятора</a> на сайті Автолюкса' //$this->currency->format($cost)
