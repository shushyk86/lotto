<?
	...
	$message = ($_GET['Result']=='inprogreess')?'Платеж находится в обработке':'Вы сможете оплатить его после проверки менеджером. Ссылка на оплату будет выслана Вам по электронной почте';
