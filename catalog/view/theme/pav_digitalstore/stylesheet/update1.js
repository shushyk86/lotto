$(document).ready(function() {
	...
	$('.social-footer').append('<a id="ig2" href=""></a> <a id="vk2" href="http://vk.com/lottoukraine"></a> <a id="yot2" href="https://www.youtube.com/channel/UCjmnHlOhS9ME5yB8ghfZ7oQ"></a> <a id="fb2" href="https://www.facebook.com/Lotto.UA"></a>')
	...
	$('.main-column').prepend('<p class="shows visible-xs visible-sm"><i class="fa fa-bars"></i>фильтр товаров</p>');
	$(".page-common-home .h-tabs li a").removeAttr("data-toggle");  //25.10.16
	$(".page-common-home .h-tabs li a").attr("href", "/rasprodaza"); //25.10.16
      ...
      $(function(){
	    $(window).scroll(function() {
	        var top = $(document).scrollTop();
		        if (top < 100) $(".shows").css({top: '-27.2vw', position: 'absolute'});
