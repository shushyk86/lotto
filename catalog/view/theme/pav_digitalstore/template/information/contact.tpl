...
<div id="content"><?php echo $content_top; ?>
	...
	<div class="grafik_rab">
		<p>График работы колл-центра интернет магазина Lotto - пн-пт с 9:00 до 19:00, сб-вс с 9:00 до 16:00</p>
	</div>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <h2 class="contact-customhtml1"><?php echo $text_location; ?></h2>
...
<!--	<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=pfgXHNPQtEdU-I-GoHwFn-0y7KkqA8pr&width=auto&height=450"></script>	-->

<script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=LrGxespBxTnWF3c8kaUn4_hkC6H5ASrP&amp;width=100%&amp;height=450&amp;lang=ru_UA&amp;sourceType=constructor&amp;scroll=true"></script>
