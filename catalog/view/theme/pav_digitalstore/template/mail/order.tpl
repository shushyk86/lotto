    ...
    <tbody>
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_order_id; ?></b> <?php echo $order_id; ?><br />
          ...
          <?php } ?></td>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><br /><b><?php echo $text_email; ?></b> <?php echo $email; ?><br />
    ...
    <tbody>
      ...
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $product['name']; ?>
          ...
          <?php } ?>
          <?php if($admin_alert) { ?>
            <?php if($product['new_collection']) { ?>
              <br />
              <b>! Товар из новой коллекции</b>
            <?php } ?>
            <?php if($product['weeksale']) { ?>
              <br />
              <b>! Товар из распродажи недели</b>
            <?php } ?>
          <?php } ?>
        </td>
