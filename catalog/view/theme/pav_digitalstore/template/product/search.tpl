	  ...
	  <div class="product-list"> <div class="products-block">
			  ...
			  foreach ($articles as $i => $article) { ?>
				  ...
				  <div class="row products-item">
					  ...
					  <div class="col-xs-6 col-lg-<?php echo $span;?> col-sm-<?php echo $small;?> col-xs-<?php echo $mini;?>">
						  ...
						  <div class="product-block clearfix ">
							  ...
							  <?php if ($article['thumb']) { ?>
								  ...
								  <div class="image">
									  <a class="img" href="<?php echo $article['href']; ?>"><img src="<?php echo $article['thumb']; ?>" title="<?php echo $article['name']; ?>" alt="<?php echo $article['name']; ?>" /></a>
								  </div>
							  ...
							  <div class="product-meta">
								  ...
								  <h3 class="name"><a href="<?php echo $article['href']; ?>"><?php echo $article['name']; ?></a></h3>
								  <div class="date-added"><?php echo $article['date_added']; ?></div>
								  <div class="description"><?php echo $article['description_mini']; ?></div>

								  <div class="cart">
									  <div class="under-color">
										  <a id="details_button" href="<?php echo $article['href']; ?>" class="btn">
											  <span>Подробнее</span>
										  </a>
									  </div>
					  ...
					  <?php if( $i%$cols == 0 || $i==count($articles) ) { ?>
