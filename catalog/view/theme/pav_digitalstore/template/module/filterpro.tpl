...
<div class="option_name">ЦЕНЕ:</div>
...
<div class="option_box">
	...
	<div class="collapsible" <?php if(!$expanded_tags){echo 'style="display:none"';}?>>
		<table id="filter_tags">
			...
			<tr>
				<td>
					<input id="tag_<?php echo $tag['tag']; ?>" class="filtered checkbox othercheckbox"
...
<div class="option_box">
		...
		<div class="option_name <?php if(!$attribute_value['expanded']){echo "hided";}?>"><?php echo $attribute_value['name']; ?></div>
			<div class="collapsible" <?php if(!$attribute_value['expanded']){echo 'style="display:none"';}?>>
				...
				<table>
					...
					<tr>
						<td>
							<span id="othercheckboxscale2" class="checkboxcontainer">

								<input class="filtered a_name checkbox othercheckbox"
	...
	<div class="option_box">
		...
		<table class="collapsible full" <?php if(!$option['expanded']){echo 'style="display:none"';}?>>
			<?php foreach($option['option_values'] as $option_value) { ?>
			<tr>
				<td>
		...
		<table class="collapsible" <?php if(!$option['expanded']){echo 'style="display:none"';}?>>
			...
			<tr>
				<td>
					  <span id="othercheckboxscale2" class="checkboxcontainer">
							<input class="filtered option_value checkbox othercheckbox" id="option_value_<?php echo $option_value['option_value_id']?>"
...
<script type="text/javascript">
	...
	$('.full label').each( function() {
		var forI = $(this).attr('for');
		var idd = $('#'+forI).attr('disabled');
		if(idd) {
