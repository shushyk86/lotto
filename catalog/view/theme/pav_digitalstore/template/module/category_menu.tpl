<div id="cmpro-<?php echo $module; ?>" class="<?php echo $box_class; ?>">
  ...
  <?php } ?>
  <div class="<?php echo $content_class; ?>"  style=" padding: 15px 10px;">
    <ul class="cmpro-<?php echo $style; ?> list <?php echo $position; ?>">
      ...
      <li class="cid-<?php echo $category['category_id']; ?><?php echo $category['active'] ? ' active' : ''; ?>">
        ...
        <ul>
          ...
          <li class="cid-<?php echo $child['cid']; ?><?php echo $child['active'] ? ' active' : ''; ?>">
            <div><a href="<?php echo $child['href']; ?>" class="<?php echo ($child['child2_id'] && $toggle == 0 ? 'parent-item' : ''); ?><?php echo ($child['child2_id'] && $toggle ? 'tb-item' : ''); ?><?php echo $child['active'] ? ' active' : ''; ?>"> <span>
			<?php if ($icon && $child['icon_thumb']) {  ?>
				<span class="item-icon" style="display:inline;padding:0"><img src="<?php echo $child['icon_thumb']; ?>" alt="<?php echo $child['link_title']; ?>"></span>
			<?php }  ?>
          <?php echo $child['name']; ?>
            </span></a>
            ...
            <ul>
              ...
              <li class="cid-<?php echo $child2['cid']; ?><?php echo $child2['active'] ? ' active' : ''; ?>">
                <div> <a href="<?php echo $child2['href']; ?>" class="<?php echo ($child2['child3_id'] && $toggle == 0 ? 'parent-item' : ''); ?><?php echo ($child2['child3_id'] && $toggle ? 'tb-item' : ''); ?><?php echo $child2['active'] ? ' active' : ''; ?>"><span>
               	<?php if ($icon && $child2['icon_thumb']) {  ?>
					<span class="item-icon" style="display:inline;padding:0"><img src="<?php echo $child2['icon_thumb']; ?>" alt="<?php echo $child2['link_title']; ?>"></span>
				<?php }  ?>
                ...
                <ul>
                  ...
                  <li class="cid-<?php echo $child3['cid']; ?><?php echo $child3['active'] ? ' active' : ''; ?>">
                    <div> <a href="<?php echo $child3['href']; ?>" class="<?php echo ($child3['child4_id'] && $toggle == 0 ? 'parent-item' : ''); ?><?php echo ($child3['child4_id'] && $toggle ? 'tb-item' : ''); ?><?php echo $child3['active'] ? ' active' : ''; ?>"><span>
                  	<?php if ($icon && $child3['icon_thumb']) {  ?>
						<span class="item-icon" style="display:inline;padding:0"><img src="<?php echo $child3['icon_thumb']; ?>" alt="<?php echo $child3['link_title']; ?>"></span>
					<?php }  ?>
                    <?php echo $child3['name']; ?></span></a>
