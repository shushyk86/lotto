...
_tmr.push({
type: 'itemView',
productid: [<?php for($i = 0; $i < count($products); $i++) { ?>'<?php echo $products[$i]['sku']; ?>'<?php if($i != (count($products) - 1)) { echo ", "; } } ?>],
pagetype: 'cart',
totalvalue: '<?php echo $temp_total; ?>',
list: '1' });
</script>
 ...
 <h1><?php echo $heading_title; ?>
      ...
      <table class="pav-shop-cart">
        <thead>
          <tr>
            ...
            <td class="price">Цена за единицу</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <span class="minus11"> - </span>

            <input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>"/>

            <span onclick="jQuery(this).prev().val(~~jQuery(this).prev().val()+1);"> + </span>
            ...
            <td class="remove">
              <a href="<?php echo $product['remove']; ?>"><span>x</span></a>
            </td>
            <td></td>
          </tr>
          <?php } ?>
  ...
  <div class="row">
  	<div  class="col-lg-10 col-md-9 col-sm-9 col-xs-12">  
  		<div class="cart-total clearfix total333">
        <table id="total">
          <?php foreach ($totals as $total) { ?>
          <tr>
          <td class="right"><span><?php echo $total['title']; ?>:</span></td>
          <td class="right pull-right"><b><?php echo $total['text']; ?></b></td>
          </tr>
          <?php } ?>
        </table>
      </div>
      ...
      <div class="buttons clearfix total333">
        <div class="pull-right">
          <a href="<?php echo $checkout; ?>" class="button">оформить заказ</a>
        </div>
      </div>
  	</div>     
  </div>  
...
{ 
	"id": "<?php echo $products[$i]['sku']; ?>",
	"number": "<?php echo $products[$i]['quantity']; ?>"
    ...
    window._retag.push({code: "9ce88868a6", level: 3});
    (function () {
