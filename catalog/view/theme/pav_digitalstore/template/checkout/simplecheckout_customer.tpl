<div class="simplecheckout-block-heading" <?php echo $simple_customer_hide_if_logged ? 'style="display:none"' : '' ?>>
    ...
    <?php } ?>
    <div class="simplecheckout-customer-block__wrapp"><span class="simplecheckout-customer-block__wrapp--title">Ваши данные</span></div>
</div>

<div class="simplecheckout-block-content" style="padding-bottom: 0;" <?php echo $simple_customer_hide_if_logged ? 'style="display:none"' : '' ?>>
    ...
    <?php if ($simple_customer_view_address_select && !empty($addresses)) { ?>
        <div class="simplecheckout-customer-address">
            <div class="simplecheckout-customer-block__wrapp" style="padding-bottom: 0;">
                <div class="simplecheckout-customer-one-column">
                    <p><?php echo $text_select_address ?>:</p>
                            ...
                            <?php if (!$customer_logged) { ?>
                                ...
                                <?php if (!($simple_customer_view_email == Simple::EMAIL_NOT_SHOW && ($simple_customer_action_register == Simple::REGISTER_NO || ($simple_customer_action_register == Simple::REGISTER_USER_CHOICE && !$register)))) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="simplecheckout-customer-right" id="email_tab">
...
<?php if ($simple_show_shipping_address) { ?>
    <div class="simplecheckout-customer-same-address">
        <?php if ($simple_show_shipping_address_same_show) { ?>
            <label><input type="checkbox" name="shipping_address_same" id="shipping_address_same" value="1" <?php if ($shipping_address_same) { ?>checked="checked"<?php } ?> reload="address_same">&nbsp;<?php echo $entry_address_same ?><b>aaaaaa</b></label>

        <?php } ?>
    </div>
    <?php if (!$shipping_address_same) { ?>
        <div class="simplecheckout-block-content simplecheckout-shipping-address simplecheckout-customer-block__wrapp" style="padding-top: 0;padding-left: 6px;" <?php echo $simple_address_hide_if_logged ? 'style="display:none"' : '' ?>>
