<div class="simplecheckout-block-heading"><div class="simplecheckout-customer-block__wrapp"><span class="simplecheckout-customer-block__wrapp--title">Способ доставки</span></div></div>
...
<div class="simplecheckout-block-content">
    ...
    <div class="simplecheckout-customer-block__wrapp">
        ...
        <table class="simplecheckout-methods-table simplecheckout-methods-table__custom-small">
            ...
            <?php foreach ($shipping_methods as $shipping_method) { ?>
                ...
                <?php if (empty($shipping_method['error'])) { ?>
                    <?php foreach ($shipping_method['quote'] as $quote) { ?>
                        ...
                        <tr>
                            <td class="code">
                                <input type="radio" name="shipping_method" value="<?php echo $quote['code']; ?>" id="<?php echo $quote['code']; ?>" <?php if ($quote['code'] == $code) { ?>checked="checked"<?php } ?> onchange="simplecheckout_reload('shipping_changed'), repl(), updt();" />
                            </td>
                            <td class="title" valign="middle">
                            ...
                            <td class="quote">
                                <label for="<?php echo $quote['code']; ?>"><?php echo ($quote['text'] == "0 грн.") ? "бесплатно" : $quote['text']; ?></label>
                            </td>
                        </tr>
...
<script type="text/javascript">
    ...
    function repl() {
        $('#total_total').detach();
        setTimeout(function() {
            $('#total_total').appendTo('.total-block11').show();
        }, 1000)
