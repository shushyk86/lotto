			...
			foreach ($categories as $category) {
				...
				foreach ($children as $child) {
					...
					foreach ($children2 as $child2) {
						...
						foreach ($children3 as $child3) {
							...
							$children3_data[] = array(
								...
								'icon_thumb'   => $this->model_tool_image->resize($child3['menu_icon'], $this->data['icon_width'], $this->data['icon_height'])
								);
						}
						...
						$children2_data[] = array(
							...
							'icon_thumb'   => $this->model_tool_image->resize($child2['menu_icon'], $this->data['icon_width'], $this->data['icon_height'])
							);
					}
					...
					$children_data[] = array(
						...
						'icon_thumb'   => $this->model_tool_image->resize($child['menu_icon'], $this->data['icon_width'], $this->data['icon_height'])
						);
				}
