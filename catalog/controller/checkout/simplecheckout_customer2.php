...
class ControllerCheckoutSimpleCheckoutCustomer2 extends Controller {
    ...
    public function index() {
        ...
        $this->data['login_link'] = $this->url->link('checkout/simplecheckout_customer2/login', '', 'SSL');
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/simplecheckout_customer2.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/checkout/simplecheckout_customer2.tpl';
        } else {
            $this->template = 'default/template/checkout/simplecheckout_customer2.tpl';
        }
    ...
    private function save_cookies() {
        if ($this->config->get('simple_use_cookies') && $this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            setcookie('simple', base64_encode(serialize($this->cookies)), time() + 60 * 60 * 24);
        }
    }
    ...
    public function login() {
        ...
        $this->data['action'] = $this->url->link('checkout/simplecheckout_customer2/login', '', 'SSL');
