...
class ControllerCheckoutSimpleCheckoutShipping extends Controller {
    public function index() {
        ...
        if ((isset($this->session->data['coupon']) && !empty($this->session->data['coupon'])) || (isset($this->session->data['reward']) && !empty($this->session->data['reward']))) {
			unset($this->data['shipping_methods']['pickup']);
		}
