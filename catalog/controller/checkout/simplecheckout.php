...
class ControllerCheckoutSimpleCheckout extends Controller { 
    public function index() {
        ...
        if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            $this->getChild('checkout/simplecheckout_customer2/update');
            ...
            $this->data['simplecheckout_customer2'] = $this->getChild('checkout/simplecheckout_customer2');
            ...
            $this->data['prods'] = $this->cart->getProducts();
        ...
        if ($version < 152) {
            ...
            foreach ($this->cart->getProducts() as $product) {
                ...
                $product_data[] = array(
                    ...
                    'reward'     => round((int)$product['price'] * $product['quantity'] * 0.05)
                ); 
            }
