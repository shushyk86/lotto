...
$_['button_clearcache_suppler']             = 'Удалить фото товаров';
...
// Description
$_['image_description']       = 'Удаление Кэш файлов изображений расположенных на сервере в папке: image/cache/..';
$_['image_description_suppler']       = 'Удаление изображений товаров расположенных на сервере в папке: image/data/photo/..<br> 
										Внимание! Это удалит ВСЕ фото товаров! Выполнение этой команды предполагает дальнейшую загрузку прайса.';
$_['system_description']     = 'Удаление Системных Кэш файлов расположенных на сервере в папке: system/cache/..';
$_['vqmod_description']     = 'Удаление Vqmod Кэш файлов расположенных на сервере в папке: vqmod/vqcache/..';
