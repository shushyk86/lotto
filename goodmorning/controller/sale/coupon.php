...
class ControllerSaleCoupon extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['coupons'][] = array(
				...
				'all_product'   => $result['all_product'],
	...
	protected function getForm() {
		...
		if (isset($this->request->post['all_product'])) {
			$this->data['all_product'] = $this->request->post['all_product'];
		} elseif (!empty($coupon_info)) {
			$this->data['all_product'] = $coupon_info['all_product'];
		} else {
			$this->data['all_product'] = '';
		}
