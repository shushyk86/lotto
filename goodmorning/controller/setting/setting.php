...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['text_sizestab'] = $this->language->get('text_sizestab');	
		$this->data['text_sizestab1'] = $this->language->get('text_sizestab1');	
		$this->data['text_sizestab2'] = $this->language->get('text_sizestab2');	
		$this->data['text_sizestab3'] = $this->language->get('text_sizestab3');	
		$this->data['text_sizestab4'] = $this->language->get('text_sizestab4');	
		$this->data['text_sizestab5'] = $this->language->get('text_sizestab5');												
		$this->data['text_sizestab6'] = $this->language->get('text_sizestab6');												
		$this->data['text_sizestab7'] = $this->language->get('text_sizestab7');					
		...
		if (isset($this->request->post['config_sizestab1'])) {
			$this->data['config_sizestab1'] = $this->request->post['config_sizestab1'];
		} else {
			$this->data['config_sizestab1'] = $this->config->get('config_sizestab1');
		}
		...
		if (isset($this->request->post['config_sizestab2'])) {
			$this->data['config_sizestab2'] = $this->request->post['config_sizestab2'];
		} else {
			$this->data['config_sizestab2'] = $this->config->get('config_sizestab2');
		}

		if (isset($this->request->post['config_sizestab3'])) {
			$this->data['config_sizestab3'] = $this->request->post['config_sizestab3'];
		} else {
			$this->data['config_sizestab3'] = $this->config->get('config_sizestab3');
		}

		if (isset($this->request->post['config_sizestab4'])) {
			$this->data['config_sizestab4'] = $this->request->post['config_sizestab4'];
		} else {
			$this->data['config_sizestab4'] = $this->config->get('config_sizestab4');
		}

		if (isset($this->request->post['config_sizestab5'])) {
			$this->data['config_sizestab5'] = $this->request->post['config_sizestab5'];
		} else {
			$this->data['config_sizestab5'] = $this->config->get('config_sizestab5');
		}						
		if (isset($this->request->post['config_sizestab6'])) {
			$this->data['config_sizestab6'] = $this->request->post['config_sizestab6'];
		} else {
			$this->data['config_sizestab6'] = $this->config->get('config_sizestab6');
		}						
		if (isset($this->request->post['config_sizestab7'])) {
			$this->data['config_sizestab7'] = $this->request->post['config_sizestab7'];
		} else {
			$this->data['config_sizestab7'] = $this->config->get('config_sizestab7');
		}						
