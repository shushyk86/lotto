...
class ControllerModulejvquickorder extends Controller {
	...
	public function index() {
      ...
      'entry_how_time_show_popup_message',
      ...
      'how_time_show_popup_message' => 'error_how_time_show_popup_message'
		);
	...
	public function install() {
      ...
      'how_time_show_popup_message' => 3500,
    ...
    if (isset($this->request->post)) {
      $how_time_show_popup_message = $this->request->post['how_time_show_popup_message'];
      $how_time_show_popup_message = (int)($how_time_show_popup_message);
      
      if ( ($how_time_show_popup_message <= 0) || !is_int(($how_time_show_popup_message))) {
        $this->error['how_time_show_popup_message'] = $this->language->get('error_how_time_show_popup_message');
      }
		}
