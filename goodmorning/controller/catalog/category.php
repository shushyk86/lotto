...
//		$this->printCategoriesId();
	}

	// выводит список категорий с айдишниками в таблицу (для бухгалтерии)
	public function printCategoriesId() {
		$main_categories = $this->model_catalog_category->getAllCategories();
		$categories = $this->model_catalog_category->getCategories($main_categories);
		echo "<table>
				<thead>
					<tr>
						<td>Категория</td>
	...
	//	$this->data['entry_user_script'] = $this->language->get('entry_user_script');
