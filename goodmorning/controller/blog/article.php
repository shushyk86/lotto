...
class ControllerBlogArticle extends Controller {
	...
	public function name() {
  	...
  	private function getForm() {
		...
		$this->data['entry_banner_top'] = $this->language->get('entry_banner_top');
		$this->data['entry_store'] = $this->language->get('entry_store');
		$this->data['entry_keyword'] = $this->language->get('entry_keyword');
		$this->data['entry_location'] = $this->language->get('entry_location');
    	$this->data['entry_image'] = $this->language->get('entry_image');
    	$this->data['entry_image_sidebanner'] = $this->language->get('entry_image_sidebanner');
        ...
        if (isset($this->request->post['banner_top'])) {
            $this->data['banner_top'] = $this->request->post['banner_top'];
        } elseif (!empty($article_info)) {
            $this->data['banner_top'] = $article_info['banner_top'];
        } else {
            $this->data['banner_top'] = 0;
        }
        ...
        $this->data['all_categories'] = $this->model_catalog_category->getCategories($all_categories);

        if (isset($this->request->post['product_category'])) {
            $product_categories = $this->request->post['product_category'];
        } elseif (isset($this->request->get['article_id'])) {
            $product_categories = $this->model_blog_article->getArticleRelatedCategories($this->request->get['article_id']);
        } else {
