...
class ModelDesignBanner extends Model {
	public function addBanner($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', date_added = NOW(), status = '" . (int)$data['status'] . "'");
	...
	public function editBanner($banner_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', date_modified = NOW(), status = '" . (int)$data['status'] . "' WHERE banner_id = '" . (int)$banner_id . "'");
