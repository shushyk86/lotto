...
//			$message .= sprintf($this->language->get('text_reward_total'), $this->getRewardTotal($customer_id));
            ...
            $template->data['points'] = $points;
            $template->data['points_total'] = $this->getRewardTotal($customer_id);

            if (file_exists('goodmorning/view/template/mail/reward.tpl')) {
                $html = $template->fetch('mail/reward.tpl');
            } else {
                $html = $template->fetch('mail/reward.tpl');
            }
