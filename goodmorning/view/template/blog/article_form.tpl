      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea cols="150" rows="10" name="article_description[<?php echo $language['language_id']; ?>][description_mini]"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['description_mini'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_tags; ?></td>
                <td><input type="text" name="article_description[<?php echo $language['language_id']; ?>][tags]" maxlength="255" size="100" value="<?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['tags'] : ''; ?>" /></td>
              </tr>
            </table>
          </div>
          <?php } ?>
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_banner_top; ?></td>
              <td><?php if($banner_top) { ?>
                      <input type="checkbox" name="banner_top" value="1" checked="checked">
                  <?php } else { ?>
                      <input type="checkbox" name="banner_top" value="1">
                  <?php } ?>
        ...
        <div id="tab-links">
          <table class="form">
            ...
            <tr>
              ...
              <tr>
                  <td>Показывать на сайте в категориях:</td>
        ...
        <div id="tab-image">
            <table id="images" class="list">
                <thead>
                <tr>
                    <td class="left"><?php echo $entry_image_sidebanner; ?></td>
                ...
                <?php foreach ($article_images as $article_image) { ?>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="article_image[<?php echo $image_row; ?>][link]" value="<?php echo $article_image['link']; ?>" /></td>
...
function addImage() {
    ...
    html += '    <td class="left"><input type="text" name="article_image[' + image_row + '][link]" value="" /></td>';
