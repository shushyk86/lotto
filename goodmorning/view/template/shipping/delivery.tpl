    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><input type="text" name="delivery_min_total_for_free_delivery" value="<?php echo $delivery_min_total_for_free_delivery; ?>" /></td>
        </tr>
        <tr>
          <td>
              <?php echo $entry_delivery_price; ?>
          </td>
          <td><input type="text" name="delivery_delivery_price" value="<?php echo $delivery_delivery_price; ?>" /></td>
        </tr>
        <tr>
