  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo $heading_title; ?></h1>
		<div class="buttons" style="float: left;"><a onclick="resetProductViews();" class="button"><?php echo $button_reset; ?></a></div>
        ...
        <table class="list">
          <thead>
           <tr id="head">
              ...
              <td class="left"><?php if ($sort == 'pd.name') { ?>
			   ...
			   <td class="left"><?php if ($sort == 'pv.viewed') { ?>
					   <a href="<?php echo $sort_views; ?>" class="<?php echo strtolower($order); ?>">Кол-во просмотров</a>
				   <?php } else { ?>
					   <a href="<?php echo $sort_views; ?>">Кол-во просмотров</a>
				   <?php } ?>
			   </td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo $product['views']; ?></td>
              <td class="left"><div id="<?php echo $product['product_id']; ?>" class="inlineEditm"><?php echo $product['sku']; ?></div></td>
...
<tr>
              ...
              <td class="left"><div class="inlineEditm">${sku}</div></td>
...
function resetProductViews() {
	$.ajax({
		url: 'index.php?route=catalog/product/resetViews&token=<?php echo $token; ?>',
		type: 'post',
		dataType: 'json',
		success: function(json) {
			if (json['success']) {
