...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-store"><?php echo $tab_store; ?></a><a href="#tab-local"><?php echo $tab_local; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-sizestab"><?php echo $text_sizestab; ?></a><a href="#tab-ftp"><?php echo $tab_ftp; ?></a><a href="#tab-mail"><?php echo $tab_mail; ?></a><a href="#tab-fraud"><?php echo $tab_fraud; ?></a><a href="#tab-sms"><?php echo $tab_sms; ?></a><a href="#tab-server"><?php echo $tab_server; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-sizestab">
          <table class="form">
            <tr>
              <td><?php echo $text_sizestab1; ?></td>
              <td><textarea name="config_sizestab1" cols="40" rows="5"><?php echo $config_sizestab1; ?></textarea></td>
            </tr>
            <tr>
              <td><?php echo $text_sizestab2; ?></td>
              <td><textarea name="config_sizestab2" cols="40" rows="5"><?php echo $config_sizestab2; ?></textarea></td>
            </tr>
            <tr>
              <td><?php echo $text_sizestab3; ?></td>
              <td><textarea name="config_sizestab3" cols="40" rows="5"><?php echo $config_sizestab3; ?></textarea></td>
            </tr>
            <tr>
              <td><?php echo $text_sizestab4; ?></td>
              <td><textarea name="config_sizestab4" cols="40" rows="5"><?php echo $config_sizestab4; ?></textarea></td>
            </tr>
            <tr>
              <td><?php echo $text_sizestab5; ?></td>
              <td><textarea name="config_sizestab5" cols="40" rows="5"><?php echo $config_sizestab5; ?></textarea></td>
            </tr>                                    
            <tr>
              <td><?php echo $text_sizestab6; ?></td>
              <td><textarea name="config_sizestab6" cols="40" rows="5"><?php echo $config_sizestab6; ?></textarea></td>
            </tr>                                    
            <tr>
              <td><?php echo $text_sizestab7; ?></td>
              <td><textarea name="config_sizestab7" cols="40" rows="5"><?php echo $config_sizestab7; ?></textarea></td>
            </tr>                                    
          </table>
        </div>
