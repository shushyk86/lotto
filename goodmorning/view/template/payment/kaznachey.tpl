  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
        <td><span></span><?php echo $copy_success_url_text; ?></td>
        <td><input type="text" name="copy_success_url" value="<?php echo $copy_success_url; ?>"  size="50" />
          <br />
          <?php if ($copy_success_url) { ?>
          <span class="error"><?php echo $copy_success_url; ?></span>
          <?php } ?></td>
        </tr>
        ...
        <tr>
        <td><span></span><?php echo $lang_panel; ?></td>
        <td><select name="kaznachey_language">
            <?php $sel='selected="selected"'?>
            <option value="RU" <?php ($kaznachey_language=='RU')?$sel:''?> ><?php echo $kaznachey_russian; ?></option>
            <option value="EN" <?php ($kaznachey_language=='EN')?$sel:''?> >English</option>
          </select></td>
        </tr>
