      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
			...
			<tr>
              <td>учитывать скидку только если ВСЕ ЭТИ ТОВАРЫ добавленны в корзину</td>
              <td><input type="checkbox" name="all_product" value="1" <?if($all_product){?>checked="checked"<?}?>/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
