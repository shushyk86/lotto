  ...
  <div class="content">
   ...
   <div id="tab-clean">
      <table class="list">
		...
		<tr>
            <td class="left"><?php echo $image_description_suppler; ?></td>
			<td class="left"><div class="buttons"><a href="<?php echo $clearcache_suppler; ?>" class="button"><?php echo $button_clearcache_suppler; ?></a></div></td>
   		</tr>
		<tr>
