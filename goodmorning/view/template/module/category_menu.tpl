          ...
          <div id="tab-module-setting-<?php echo $module_row; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><select name="category_menu_module[<?php echo $module_row; ?>][layout_id]" class="span3">
...
function addModule() {
  ...
  html += '        <td><select name="category_menu_module[' + module_row + '][layout_id]" class="span3">';
  <?php foreach ($layouts as $layout) { ?>
