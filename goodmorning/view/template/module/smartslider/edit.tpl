										...
										<div class="product_labels" style="margin-botom:8px;">
											...
											<div class="product_label" data-type="<?php echo $label['type'] ?>">
												...
												<?php if($label['type'] == 'discount') {?>
													<input style="width: 40px;" type="text" name="discount_val" value="" >
												<?php }?>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
							<input type="checkbox" name="height_auto" value="true" <?php if(isset($slider['properties']['height_auto'])) echo  "checked"; ?> >  Auto Height
							<input type="text" name="height" value="<?php echo $slider['properties']['height'] ?>" class="input"></td>
